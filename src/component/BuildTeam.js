        ...
        return(
            <div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 9)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 10)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 5)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 6)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 7)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                ...
                <div className="col-md-2">
                {
                    ...
                    <div className="card" onClick={this.assignPlayer.bind(this, 1)}>
                        <div className="row">
                            <div className="col-md-4" >
                                <div></div>
                            </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 2)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 3)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 4)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
                    ...
                    <div className="col-md-2">
                        {
                            ...
                            <div className="card" onClick={this.assignPlayer.bind(this, 0)}>
                                <div className="row">
                                    <div className="col-md-4" >
                                        <div></div>
                                    </div>
